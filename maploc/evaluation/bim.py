...
from ..data import BimDataModule
from .run import evaluate


data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "bim.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = BimDataModule(cfg.get("data", {}))

    metrics = evaluate(experiment, cfg, dataset, split=split, sequential=sequential, **kwargs)
